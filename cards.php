...
$selectedCard = isset($_GET['card']) ? $_GET['card'] : 'Quick_sketch';
?>
<!DOCTYPE html>
...
.card-text { font-size: 1rem; line-height: 1.5; color: #333333; }
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" style="max-width:50%; background-color:#c688bb;">
            <div class="offcanvas-body d-flex flex-column align-items-center pt-5">
                <ul class="navbar-nav w-100 text-center" style="gap: 20px;">
                    ...
                    <li class="nav-item"><a class="nav-link" href="cards.php" style="font-size:130%; color:#eace3b;">Cards</a></li>
...
let currentIndex = cardOptions.findIndex(opt => opt.value === "<?php echo $selectedCard; ?>");
if(currentIndex === -1) currentIndex = 0;

function loadCard(index) {
    const action = cardOptions[index].value;
